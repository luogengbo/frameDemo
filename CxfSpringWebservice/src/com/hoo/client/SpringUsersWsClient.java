...
//        getByUrl();
        ...
        IComplexUserService service = (IComplexUserService)ctx.getBean("userWsClient", IComplexUserService.class);
    ...
    public static void getByUrl()
    {
        ...
        factory.setAddress("http://localhost:8080/CxfSpringWebservices/Users");
